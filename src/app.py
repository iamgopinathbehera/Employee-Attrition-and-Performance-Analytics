...
st.image(r"C:\Users\ASUS\ML Domain Studies\Machine Learning\Employee Attrition and Performance Analytics\src\attrition_banner.png", use_column_width=True)
st.markdown(
    """
...
if st.sidebar.button("Predict Attrition 💡"):
    ...
    if prediction == 1:
        ...
        st.image(r"C:\Users\ASUS\ML Domain Studies\Machine Learning\Employee Attrition and Performance Analytics\src\leaving.png", caption="Employee at risk!", use_column_width=True)  
    else:
        st.success("🟢 The employee is likely to stay with the organization.")
        st.image(r"C:\Users\ASUS\ML Domain Studies\Machine Learning\Employee Attrition and Performance Analytics\src\stayings.png", caption="Employee retention strong!", use_column_width=True)  
